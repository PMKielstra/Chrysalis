...
class Profile:
    ...
    def __init__(self, N, dimens, eps, levels, distance=1, direction=BOTH, subsamples = 20, translation_invariant=False, flat=False, as_matrix = False, use_fake = False, verbose = False, boost_subsamples = True, processes=None):
        assert N > 0
        assert dimens > 0
        assert eps < 1
